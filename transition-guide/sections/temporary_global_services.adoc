== 4.   TEMPORARY GLOBAL SERVICES

=== 4.1 GTS to WIS2 gateway
...
==== 4.1.2  GTS to WIS2 gateway provider
...
===== 4.2.3.2 Guidance for WIS2 to GTS gateway operators
...
== 5. STOPPIONG A MESSAGE SWITCHING SYSTEM
