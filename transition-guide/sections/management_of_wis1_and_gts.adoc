...
=== 6.1 Maintenance and operation of Message Switching Systems

==== 6.1.1 Main Telecommunication Network
...
==== 6.1.2 Regional Telecommunication Hubs
...
==== 6.1.3 National Meteorological Centres
...
=== 6.2 Maintenance and operation of WIS1 Catalogue and Cache by GISCs
