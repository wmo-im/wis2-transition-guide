:title: Provisions for the Transition from the WMO Information System (WIS) 1.0 and Global Telecommunication System to WIS 2.0 (WMO-No. 1323) (APPROVED)
:titletext: {title}
:version: 1.0.0
:date: {docdate}
...
|Revision history: see <<_revision_history,Annex A>>
